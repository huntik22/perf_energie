...
import 'package:login/models/common/user_models.dart';
...
void loginTrigger({required BuildContext context, required UserModel userModel,required String route}) async {

  bool isEmail = GetUtils.isEmail(userModel.email);

  String? loggedPref = await storage.read(key: 'logged');
  if (loggedPref == null || loggedPref.isEmpty || loggedPref != "true" || userModel == "" || isEmail==false ) {
