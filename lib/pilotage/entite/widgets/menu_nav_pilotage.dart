...
class MenuNavPilotage extends StatefulWidget {
  ...
  const MenuNavPilotage({Key? key, required this.responsive}) : super(key: key);
...
class CustomMenuButton extends StatefulWidget {
  ...
  final String label;
  final IconData icon;
  const CustomMenuButton({Key? key, 
        required this.isExtended,
        required this.label,
        required this.icon,
        required this.pathMenu, required this.isFullPath, required this.image}) : super(key: key);
...
class _CustomMenuButtonState extends State<CustomMenuButton> {
  ...
  String _rootLocation = "/pilotage/espace/ayame";
          ...
          child: Row(
            children: [
              ...
              widget.image == "" ? Icon(
                widget.icon,
                size: 25,
                color: isSelected ? Color(0xFF114693) : Colors.black,
          ...
          child: JustTheTooltip(
            ...
            child: Container(
              ...
              decoration: isSelected ? BoxDecoration(
                ...
                color: _isHovering ?Color(0xFFEEEEEE) :Color(0xFFE8F0FE),
              ):null,
              child: IconButton(
                onPressed: (){
                  if (widget.pathMenu != "/d") {
                ...
                icon: Icon(widget.icon,size: 25,color: isSelected ? Color(0xFF114693) : Colors.black),
              ),
            ),
          ),
        ),
